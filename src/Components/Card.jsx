...
const Card = ({ data }) => {
  ...
  return (
    <div
      ...
      className="repo duration-700 ease-in-out transition-all w-[60%] h-[40%]  rounded-2xl p-3 flex-col flex justify-between"
    >
      <h1 className="text-[24px] font-bold">{data.name}</h1>
      <div className=" sm:w-full sm:h-full sm:overflov-x-auto">
        <h1>{data.description}</h1>
      </div>
      <div className="flex justify-between  w-full py-[3px]">
